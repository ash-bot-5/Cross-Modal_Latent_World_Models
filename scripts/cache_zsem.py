"""
Pre-compute and cache z_sem latent vectors for all episodes in DATA_DIR.
...
OUT_DIR    = "/home/ashwink/full_data_5000/langtable/z_sem_latents/"
...
def main():
    ...
    # Load model and processor — copied from semantic_world_model.py:36-48
