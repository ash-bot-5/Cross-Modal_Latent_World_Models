...
Usage:
    python dynamics_model_clip_full_finetune_combined.py --smoke_test
    python dynamics_model_clip_full_finetune_combined.py --train
"""
...
def train(
    ...
    checkpoint_dir: str = "checkpoints_clip_full_fine-tuned_with_subopt_data",
    ...
    diagnostics_dir: str = "clip_full_finetune_combined_diagnostics",
    ...
    wandb.init(
        ...
        name="clip_full_finetune_combined",
        config=dict(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--resume_from", type=str, default=None,
                         help="path to a checkpoint (e.g. checkpoints_clip_full_fine-tuned_with_subopt_data/latest.pt) "
                              "to resume training from")
    parser.add_argument("--checkpoint_dir", type=str, default="checkpoints_clip_full_fine-tuned_with_subopt_data",
